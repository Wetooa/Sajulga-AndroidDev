...
public class Eval {
    public static List<Character> operationsList = new ArrayList<>(Arrays.asList('+', '-', '*', '/'));
    public static List<Character> specialOperationsList = new ArrayList<>(Arrays.asList('.', '%'));
    public static String operationsRegex = "[+\\-\\*/]";
    String isNumeric = "^\\d+$";
    ...
    public double eval(String equation) {
        ...
        return stack.stream().reduce(Double::sum).get();
    }
}
